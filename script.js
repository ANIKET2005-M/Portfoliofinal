...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Pre-final year Computer Science & Eng. (Data Science)",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "student at SVIT, Bengaluru. GPA: 8.3/10",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor("   Tech Lead at Data Vision Club", "#ff8c00")}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
  "   ML engineering, data analytics, Generative AI,",
  "#ffffff"
)}
${this.wrapWithColor(
...
${this.wrapWithColor(
  "   Building real-time systems, predictive modeling,",
  "#ffffff"
)}
${this.wrapWithColor("   and turning raw data into impact.", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Ready to build the next generation of AI systems!",
      "#ffffff"
...
<span style="color: #00ffff;">Unified Mentor Pvt. Ltd. | Data Analyst Intern</span>
${this.wrapWithColor(
  "Feb 2026 - May 2026 | Gurugram, Haryana (Remote)",
  "#ffffff"
)}
${this.wrapWithColor(
  "Data cleaning, EDA, and feature analysis",
  "#98fb98"
)}

• ${this.wrapWithColor("Data Preprocessing", "#ffa07a")} - ${this.wrapWithColor(
...
• ${this.wrapWithColor(
      ...
      "Built interactive Power BI dashboards to communicate insights",
      "#ffffff"
    )}
• ${this.wrapWithColor("Insight Generation", "#ffa07a")} - ${this.wrapWithColor(
      "Identified anomalies and patterns for decision-making",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Python, Pandas, Power BI, EDA, Excel, Statistical Analysis",
      "#87cefa"
    )}

<span style="color: #00ffff;">Data Vision Club | Tech Lead</span>
${this.wrapWithColor(
...
• ${this.wrapWithColor("Community Building", "#ffa07a")} - ${this.wrapWithColor(
      "Fostered a data-driven community on campus",
      "#ffffff"
    )}
• ${this.wrapWithColor("Hackathon", "#ffa07a")} - ${this.wrapWithColor(
      "Conducted a hackathon with over 60 participants",
      "#ffffff"
    )}
• ${this.wrapWithColor("Seminars", "#ffa07a")} - ${this.wrapWithColor(
      "Hosted an AI/Data Science industry seminar",
      "#ffffff"
    )}

${this.wrapWithColor("Skills applied:", "#00ffff")} ${this.wrapWithColor(
      "Leadership, Event Management, Data Science Strategy, Public Speaking",
      "#87cefa"
    )}`;
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " B.E. Computer Science & Eng. (Data Science) ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "└──────────────────────────────────────────────────┘",
...
${this.wrapWithColor("🏛️ Institution:", "#ff8c00")} ${this.wrapWithColor(
      "Sai Vidya Institution of Technology",
      "#ffffff"
    )}
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Foundation of my data science journey ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "╰──────────────────────────────────────────────────╯",
...
• ${this.wrapWithColor("Python, SQL, JavaScript, TypeScript, C/C++, R", "#ffffff")}

<span style="color: #00ffff;">📊 Data Analytics</span>
• ${this.wrapWithColor("EDA, Data Cleaning, Power BI, Excel", "#ffffff")}
• ${this.wrapWithColor("Statistical Analysis, Data Visualization", "#ffffff")}

<span style="color: #00ffff;">🤖 Machine Learning</span>
• ${this.wrapWithColor("scikit-learn, XGBoost, TensorFlow, PyTorch", "#ffffff")}
• ${this.wrapWithColor("Feature Engineering, Model Evaluation", "#ffffff")}

<span style="color: #00ffff;">🧠 Generative AI</span>
• ${this.wrapWithColor("LLMs, LangChain, LangGraph, RAG Pipelines", "#ffffff")}
• ${this.wrapWithColor("NLP, Hugging Face, Prompt Engineering", "#ffffff")}

<span style="color: #00ffff;">🗄️ Databases & Backend</span>
• ${this.wrapWithColor("MySQL, PostgreSQL, MongoDB, Firebase", "#ffffff")}
• ${this.wrapWithColor("Supabase, Neo4j, FastAPI", "#ffffff")}

<span style="color: #00ffff;">⚙️ MLOps & Deployment</span>
• ${this.wrapWithColor("Git, Docker, Streamlit, API Deployment", "#ffffff")}
• ${this.wrapWithColor("CI/CD, MLflow", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:aniketmaharana.28@gmail.com" style="color: #ffffff; text-decoration: none;">aniketmaharana.28@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://aniketmaharana.me" target="_blank" style="color: #ffffff; text-decoration: none;">aniketmaharana.me</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/ANIKET2005-M" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/ANIKET2005-M</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://www.linkedin.com/in/aniket-maharana-63146828b-63146828b/" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/aniket-maharana-63146828b</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  async generatePDF() {
    const outputElement = this.terminals[this.activeTerminal].input
      .closest(".terminal-content")
      .querySelector("[id^='output']");
    this.printToOutput(outputElement, "Opening PDF resume...", "info");
    
    setTimeout(() => {
      window.open('Aniket_Maharana_CV.pdf', '_blank');
      this.printToOutput(
        outputElement,
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "aniket@maharana: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    url.textContent = "aniketmaharana.me";
